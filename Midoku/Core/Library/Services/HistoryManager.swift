...
extension HistoryManager {
    func setProgress(
        ...
        await MCCollectionStore.shared.recordRead(chapterId)
    ...
    func addHistory(
        ...
        for chapter in chapters {
            await MCCollectionStore.shared.recordRead(.init(sourceKey: mangaId.sourceKey, mangaKey: mangaId.mangaKey, chapterKey: chapter.key), completed: true)
        }
    ...
    func removeHistory(chapterIds: [ChapterIdentifier]) async {
        ...
        for id in chapterIds { await MCCollectionStore.shared.recordRead(id, completed: false) }
