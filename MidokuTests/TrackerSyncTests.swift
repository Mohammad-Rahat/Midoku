...
actor TestableTracker: Tracker {
    ...
    func getTrackerInfo() async throws -> Midoku.TrackerInfo {
    ...
    func update(trackId: String, update: Midoku.TrackUpdate) async throws {}

    func getState(trackId: String) async throws -> Midoku.TrackState {
        .init(
            score: nil,
            status: nil,
    ...
    func search(for manga: AidokuRunner.Manga, includeNsfw: Bool) async throws -> [Midoku.TrackSearchItem] {
        []
    }

    func search(title: String, includeNsfw: Bool) async throws -> [Midoku.TrackSearchItem] {
        []
    }
